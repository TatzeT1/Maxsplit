...
export const de = {
  ...
  expenses: {
    ...
    lotteryIntro:
      "Handy rumreichen: Jede Person deckt ihr eigenes Gesicht auf. Wer ein lachendes Gesicht erwischt, zahlt.",
    lotteryPoolLabel: "Wer spielt mit?",
    lotteryCountLabel: "Wie viele zahlen?",
    lotteryStart: "Spiel starten",
    lotteryTapHint: "Reihum: Jede Person tippt auf ihr eigenes Gesicht.",
    lotteryRevealAll: "Rest aufdecken",
