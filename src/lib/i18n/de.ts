...
export const de = {
  ...
  expenses: {
    ...
    gameBlurbSlot: "Am Hebel ziehen und hoffen.",
    ...
    slotIntro: "Handy rumreichen: Am Hebel ziehen, die Walzen entscheiden, wer zahlt.",
    slotCountHint: "So oft wird gezogen, bis alle Zahler feststehen.",
    slotPull: "Hebel ziehen",
    slotPullAgain: "Nochmal ziehen",
    slotSpinningLabel: "Die Walzen drehen sich …",
    slotRoundResult: "{{name}} zahlt in dieser Runde.",
    slotProgress: "{{found}} von {{target}} entschieden",
