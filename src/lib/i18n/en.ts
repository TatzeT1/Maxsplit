...
export const en: Dictionary = {
  ...
  expenses: {
    ...
    gameBlurbSlot: "Pull the lever and hope.",
    ...
    slotIntro: "Pass the phone around: pull the lever, the reels decide who pays.",
    slotCountHint: "That's how many pulls it takes before every payer is decided.",
    slotPull: "Pull the lever",
    slotPullAgain: "Pull again",
    slotSpinningLabel: "The reels are spinning …",
    slotRoundResult: "{{name}} pays this round.",
    slotProgress: "{{found}} of {{target}} decided",
