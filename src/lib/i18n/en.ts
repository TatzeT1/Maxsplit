...
export const en: Dictionary = {
  ...
  expenses: {
    ...
    lotteryPoolLabel: "Who's playing?",
    lotteryPoolMinHint: "At least two people have to play.",
    lotteryCountLabel: "How many pay?",
    lotteryCountHint: "That's how many laughing faces are hidden in the grid.",
    lotteryCountDecrease: "Fewer",
    lotteryCountIncrease: "More",
    lotteryStart: "Start game",
    ...
    lotteryResultOne: "{{name}} pays.",
    lotteryResultMultiple: "{{names}} pay.",
    lotteryApply: "Apply",
    lotteryPlayAgain: "Reshuffle",
