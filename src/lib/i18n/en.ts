...
export const en: Dictionary = {
  ...
  expenses: {
    ...
    lotteryIntro:
      "Pass the phone around: everyone taps their own face. Whoever gets a laughing face pays.",
    lotteryPoolLabel: "Who's playing?",
    lotteryCountLabel: "How many pay?",
    lotteryStart: "Start game",
    lotteryTapHint: "Take turns: everyone taps their own face.",
    lotteryRevealAll: "Reveal the rest",
